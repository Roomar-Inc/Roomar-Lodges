...
function Navbottom() {
  ...
  return (
    ...
    >
      <div
        className="block w-1/4 rounded-md border-4 border-gray-300 mx-auto m-0 mb-4 cursor-pointer"
      ></div>
      <div className="flex items-center">
        <div className="h-10 w-10 p-2 bg-zinc-100 rounded-full mx-4" onClick={() => {/* Handle adjustments icon click */}}>
        ...
        <div  className="pt-0 relative" >
          ...
          />
          <div className="absolute top-2 right-7 bg-zinc-100" onClick={() => {/* Handle magnifying glass icon click */}}>
